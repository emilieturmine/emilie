/* Liste des contacts français.
 ...
 SELECT pour afficher les données souhaités,
 AS pour changer le nom des collones,
 FROM pour indiQuer dans quelle table chercher 
...
/* Nombre de produits vendus par les fournisseurs Français dans l'ordre décroissant:
 ...
 SELECT pour afficher les données souhaités,
 COUNT fonction d'agrégation elle effectue un calcul sur un ensemble de valeurs et renvoient une valeur unique ,
 AS pour changer le nom des colonnes,
 FROM pour indiQuer dans quelle table chercher ,
 WHERE pour enoncer une condition particuliere,
 AND  pour enoncer une condition supplementaire,
 GROUP BY pour regrouper les informations rechechées en fonction d'une donnée en l'occurenc par nom de companie,
...
/* Liste des clients Français ayant plus de 10 commandes 
 ...
 COUNT fonction d'agrégation elle effectue un calcul sur un ensemble de valeurs et renvoient une valeur unique ,
 AS pour changer le nom des colonnes,
 FROM pour indiQuer dans quelle table chercher en mettant une virgule on indique qu'il faut chercher dans plusieurs table ,
 WHERE pour enoncer une condition particuliere,
 AND  pour enoncer une condition supplementaire,
 GROUP BY pour regrouper les informations rechechées en fonction d'une donnée en l'occurenc par nom de companie,
...
/* Liste des clients ayants un CA > 30000:
 ...
 SUM Somme des valeurs des nombres d'une colonne de type numérique
